...
public class AdvancedScenarioAutomationUsers {
	...
	private static void createCustomer1(String customerName)
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_descriptionField")).sendKeys(" Welcome "+customerName);
	...
	private static void modifyCustomer(String customerName) {
		...
		try {
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("/html/body/div[12]/div[2]/div[2]/div[2]/div[1]/div[2]/div[1]/div[3]/div/div[1]/div")).click();
			Thread.sleep(2000);
